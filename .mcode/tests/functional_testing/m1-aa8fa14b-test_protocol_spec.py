...
Generated at: 2026-03-05T17:13:18.624406+00:00
Project: king-fast-4
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Create a new user with valid name and email",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without the required name field",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without the required email field",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "Retrieve the list of all users, expects a JSON array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "Create a user first, then verify the user list is non-empty",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
...
BASE_URL = os.path.expandvars("http://localhost:4567")
HEALTH_CHECK_ENDPOINT = os.path.expandvars("/users")
REQUEST_TIMEOUT = 30
